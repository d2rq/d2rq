...
-- 
-- Host: localhost
-- Generation Time: Sep 05, 2006 at 10:26 AM
...
INSERT INTO `organizations` (`OrgID`, `Type`, `Name`, `Address`, `Location`, `Country`, `URI`, `Belongsto`, `Homepage`) VALUES (1, NULL, 'USC Information Sciences Institute', '4676 Admirality Way, Marina Del Rey', 'California', 'United States', 'http://trellis.semanticweb.org/expect/web/semanticweb/iswc02_trellis.pdf#ISI', NULL, NULL),
(2, 'U', 'University of Karlsruhe', NULL, NULL, NULL, 'http://annotation.semanticweb.org/iswc/iswc.daml#University_of_Karlsruhe', NULL, NULL),
(3, 'U', 'International University in Germany', NULL, NULL, NULL, 'http://www.i-u.de/schools/eberhart/iswc2002/#International University in Germany', NULL, NULL),
(4, 'I', 'AIFB', NULL, 'Karlsruhe', 'Germany', 'http://annotation.semanticweb.org/iswc/iswc.daml#AIFB', NULL, 'http://www.aifb.uni-karlsruhe.de/'),
(5, 'D', 'Department of Computer Science', 'De Boelelaan 1081a', NULL, 'The Netherlands', 'http://www.cs.vu.nl/~borys/papers/abstracts/ISWC2002.html#CSVUNL', 6, NULL),
(6, 'U', 'Universiteit Amsterdam', 'De Boelelaan 1105', NULL, 'The Netherlands', 'http://www.cs.vu.nl/~borys/papers/abstracts/ISWC2002.html#VrijeUniversiteitAmsterdam', NULL, NULL),
(7, NULL, 'Hewlett-Packard Laboratories, Bristol', NULL, 'Bristol', 'UK', 'http://www.hpl.hp.co.uk#HPL', NULL, 'http://www.hpl.hp.com/'),
...
(9, 'D', 'Dipartimento di Ingegneria dell''Informazione', 'Via Vignolese 905 â€“ Modena Italy', NULL, 'Italy', 'http://www.dbgroup.unimo.it/iswc/iswc.html#DII', NULL, NULL);
...
INSERT INTO `persons` (`PerID`, `Type`, `FirstName`, `LastName`, `Address`, `Email`, `Homepage`, `Phone`, `URI`, `Photo`) VALUES (1, 'Full_Professor', 'Yolanda', 'Gil', NULL, 'gil@isi.edu', 'http://www.isi.edu/~gil', '310-448-8794', 'http://trellis.semanticweb.org/expect/web/semanticweb/iswc02_trellis.pdf#Yolanda Gil', NULL),
...
INSERT INTO `topics` (`TopicID`, `TopicName`, `URI`, `ParentID`) VALUES (1, 'Knowledge Representation Languages', 'http://annotation.semanticweb.org/iswc/iswc.daml#Knowledge_Representation_Languages', 3),
