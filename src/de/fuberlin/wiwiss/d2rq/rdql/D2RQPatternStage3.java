 ...
 */
public class D2RQPatternStage3 extends CombinedPatternStage3 {
	...
	public D2RQPatternStage3(GraphD2RQ graph, Mapping map,
		...
		D2RQPatternStage3.this.graph = graph;
	}
	...
	protected ClosableIterator resultIteratorForTriplePattern(Triple[] triples) {
		PatternQueryCombiner combiner = new PatternQueryCombiner(graph,
				stageInfo.vars.allBindings, stageInfo.vars.allExpressions, triples); // pass map?
		combiner.setup();
