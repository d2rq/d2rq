...
public class PropertyBridge implements Prefixable {
	...
	public void prefixTables(TablePrefixer prefixer) {
        ...
        subjectMaker=prefixer.prefixNodeMaker(subjectMaker, boundVar);
        predicateMaker=prefixer.prefixNodeMaker(predicateMaker, boundVar );
		objectMaker=prefixer.prefixNodeMaker(objectMaker, boundVar);
    ...
    public void prefixTables(TablePrefixer prefixer, String boundVar ) {
        //For completeness... this has to be here... though will do NOTHING
    }
    ...
    /**
     * This is only set when the property bridge has been prefixed. 
     * @param boundVar The bound variable associated with this property bridge.
     */
    ...
    /**
     * This is only set when the property bridge has been prefixed. 
     * @return the bound variable that is bound to the property bridge
     */
